...
const RestaurantItemRequestRoutes = require('./routes/Restaurant/Restaurant_item_Request.routes');
...
const PrinterTypeRoutes = require('./routes/Master/Printer_type.routes');
const PrinterRoutes = require('./routes/Master/Printer.routes');
const PrinterIssuesRoutes = require('./routes/Master/Printer_Issues.routes');
const PrinterOrdersRoutes = require('./routes/Master/Printer_Orders.routes');
const SupplierRoutes = require('./routes/Master/Supplier.routes');
...
const VendorItemsReviewsDashboardRoutes = require('./routes/ShopingVendor/Vendor_Items_Reviews_Dashboard.routes');
...
router.use('/Restaurant_item_Request', RestaurantItemRequestRoutes);
...
router.use('/Printer_type', PrinterTypeRoutes);
router.use('/Printer', PrinterRoutes);
router.use('/Printer_Issues', PrinterIssuesRoutes);
router.use('/Printer_Orders', PrinterOrdersRoutes);
...
router.use('/Vendor_Reviews_Dashboard', VendorItemsReviewsDashboardRoutes);
