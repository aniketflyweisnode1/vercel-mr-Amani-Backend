...
const ItemCategoryRoutes = require('./routes/Master/item_Category.routes');
...
const CartOrderFoodRoutes = require('./routes/User/Order_Food/Cart_Order_Food.routes');
const UserAddressRoutes = require('./routes/User/User_Address.routes');
const OrderNowRoutes = require('./routes/User/Order_Food/Order_Now.routes');
const ReferralRoutes = require('./routes/User/Order_Food/Referral.routes');
const OrderHistoryRoutes = require('./routes/User/Order_Food/Order_History.routes');
...
router.use('/Cart_Order_Food', CartOrderFoodRoutes);
