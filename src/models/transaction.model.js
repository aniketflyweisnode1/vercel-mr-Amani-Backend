...
const transactionSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['pending', 'completed', 'failed', 'requires_payment_method', 'processing', 'Payout'],
    default: 'pending'
  },
  payment_method_id: {
    type: Number,
  ...
  transactionType: {
    type: String,
    enum: ['Registration_fee', 'deposit', 'withdraw', 'Order_Now_Payment', 'Plan_Buy', 'Recharge', 'refund', 'ChargeBack', "Payout"],
