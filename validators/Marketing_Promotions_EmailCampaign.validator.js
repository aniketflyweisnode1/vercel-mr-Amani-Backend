...
const updateEmailCampaignSchema = Joi.object({
...
const getEmailCampaignByIdSchema = Joi.object({
...
const getAllEmailCampaignsSchema = Joi.object({
  ...baseListQuery
});

const getEmailCampaignsByAuthSchema = Joi.object({
  ...baseListQuery
});
