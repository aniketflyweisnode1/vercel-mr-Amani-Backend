...
const paginationSchema = {
  ...
  sortBy: Joi.string().valid('created_at', 'updated_at', 'Restaurant_Items_Reviews_Dashboard_id').default('created_at'),
...
const getDashboardByBranchParamsSchema = Joi.object({
  business_Branch_id: Joi.number().integer().positive().required()
});
